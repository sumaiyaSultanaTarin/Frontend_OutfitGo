  ...
  return (
    <div className="flex items-center justify-between bg-white px-6 py-3 shadow-md" style={{ height: "67px", width: "1186px" }}>
      ...
      <div className="flex items-center gap-6">
        ...
        >
          <button className="relative flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none">
        ...
        >
          <button className="flex items-center gap-2 py-2 px-3 rounded-md bg-gray-100 hover:bg-gray-200 focus:outline-none">
            <Image
